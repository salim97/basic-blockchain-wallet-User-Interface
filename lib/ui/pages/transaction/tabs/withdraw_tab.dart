        ...
        children: <Widget>[
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Text(
                        "Available (BCH)",
                        style: TextStyle(color: Theme.of(context).hintColor.withOpacity(0.5), fontFamily: "Popins", fontSize: 15.5),
                      ),
                      Text(
                        "0",
          ...
          Container(
            ...
            child: Center(
              child: Text(
                "Withdraw",
                style: TextStyle(fontFamily: "Popins", fontSize: 16.0, letterSpacing: 1.5, fontWeight: FontWeight.w700),
              ),
            ),
          ),
          SizedBox(
